...
const Header = () => {
    return (
        <div className="md:flex items-center gap-5 px-5 pt-5 bg-blue-50">
            <div>
                ...
                <button className="px-4 py-3 font-semibold text-white bg-blue-500 rounded-md">Get Started</button>
            </div>
